      ...
      <div className="section-container py-16">
        ...
        <div className="border-t border-cream-light/10 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="/privacy-policy" className="text-cream-light/60 hover:text-cream-light text-sm transition-colors">私隱政策</a>
            <a href="/terms-of-service" className="text-cream-light/60 hover:text-cream-light text-sm transition-colors">服務條款</a>
          </div>
          <button
            onClick={scrollToTop}
